...
public class PlayerView extends JPanel implements Observer{
    ...
    private String squareSign = "P";
    private int x;
    private int y;
    private int width;
    private int height;
    private Color colour1 = MyColor.lightGreen;
    private Color colour2 = MyColor.darkGreen;
    
    public PlayerView(final ShipView shipView, final Status status){
        this.squares = null;
    ...
    private void init(){
        ...
        for (SeaSquare square : squares) {
            SeaSquareController controller = new SeaSquareController(model, square, shipView.getShips(), status);
